...
run apt-get update
run DEBIAN_FRONTEND=noninteractive apt-get install curl cmake build-essential libxslt-dev libxml2-dev libyaml-perl libfile-slurp-perl libipc-run3-perl -y
run mkdir /hiawatha
